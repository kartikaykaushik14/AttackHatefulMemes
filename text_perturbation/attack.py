...
def text_fgsm_attack(model, test_path, perturbed_test_path) :
...
per_test_path = "QM_test_unseen.jsonl"
...
print("Starting Text pertubation")
print(text_fgsm_attack(hateful_memes_model, test_path, per_test_path))
