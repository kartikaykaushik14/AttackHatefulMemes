...
def img_fgsm_attack(model, test_path, perturbed_test_path) :
...
per_img_path = "perturbed_img_test.jsonl"
...
print("Starting Image Pertubation")
print(img_fgsm_attack(hateful_memes_model, test_path, per_img_path))
